...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 17, 2022 at 03:31 PM
...
INSERT INTO `tbl_dpr` (`dpr_id`, `kodedpr`, `dpr_nama`, `dpr_tingkat`, `nosk`, `file_sk`, `expired`, `alamat`, `email`, `notelp`, `datecreated`, `datemodified`) VALUES
...
(6, '05', 'Dewan Pimpinan Regional Jawa Timur', 'Reg', '05', '', '2023-06-09', '', '', '', '2022-06-09 17:00:00', '2022-06-17 05:32:22'),
...
INSERT INTO `tbl_user` (`user_id`, `dpr_id`, `kodeanggota`, `username`, `namalengkap`, `password`, `status`, `type`, `kehormatan`, `confirm`, `softdelete`, `datecreated`, `datemodified`) VALUES
(1, 3, '1123456', 'gdebig@gmail.com', 'I Gde Dharma Nugraha', '$2y$10$hH89Oy/AB1YHIT45dcLo4uNWb8sGtSkgi.2lEpI8vw/9zAF5qKkVK', 'aktif', 'nnny', 'tidak', 'ya', 'Tidak', '2022-05-28 21:56:14', '2022-06-17 05:42:21'),
(2, 1, '111111', 'admin@ichi.or.id', 'Super Administrator', '$2y$10$jd3XlBvax6vQCmNwA6jj1udOXIQc3bSUbz.0hJ1ugeyjhHYa3/y5q', 'aktif', 'yyyn', 'tidak', 'ya', 'Tidak', '2022-06-10 01:53:27', '2022-06-17 05:41:07'),
(4, 1, '111234', 'testadmin@ichi.or.id', 'Admin Saja', '$2y$10$XBQtK6LyHH3xcWyWwdHlvO2aAdIW7yBoDdw/pKFGiOkN5we/srl.K', 'aktif', 'nyyn', 'tidak', 'ya', 'Tidak', '2022-06-14 17:00:00', '2022-06-17 05:40:50'),
(5, 0, '123789', 'test@ichi.or.id', 'test saja', '$2y$10$mWezF6ppW1p7.1MGXCxH0erGLf/jByXSlLvKOs.Vx2qigmZOb0lWC', 'aktif', 'nnyn', 'tidak', 'ya', 'Ya', '2022-06-14 17:00:00', '2022-06-15 09:27:49');
COMMIT;

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Profile <?= $info_member['namalengkap'];?></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url();?>">Home</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url();?>/home/anggota">Daftar Anggota</a></li>
                        <li class="breadcrumb-item active"><?= $info_member['namalengkap'];?></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="5%" style="text-align:center">:</td>
                                <td width="65%">
                                    <?= $info_profile['tempatlahir'].", ".format_indo($info_profile['tanggallahir']);?>
                                </td>
                            </tr>
                            <tr>

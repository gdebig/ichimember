                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="kodedpr" name="kodedpr" class="form-control" type="text"
                            placeholder="Kode DPR / DPP..." value="<?= set_value('kodedpr');?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="dpr_nama" name="dpr_nama" class="form-control" type="text"
                            placeholder="Nama DPR / DPP..." value="<?= set_value('dpr_nama');?>" />
                    </div>
                    <br />
                    <label for="dpr_tingkat" class="element">Tingkat DPR / DPP</label>
                    <div class="element">
                        <select name="dpr_tingkat" id="dpr_tingkat">
                            <option value="Pusat" <?= set_value('dpr_tingkat')=='Pusat' ? "selected" : "";?>>Pusat
                            </option>
                            <option value="Reg" value="Pusat" <?= set_value('dpr_tingkat')=='Reg' ? "selected" : "";?>>
                                Regional</option>
                            <option value="Prov" value="Pusat"
                                <?= set_value('dpr_tingkat')=='Prov' ? "selected" : "";?>>Provinsi</option>
                            <option value="Kab" value="Pusat" <?= set_value('dpr_tingkat')=='Kab' ? "selected" : "";?>>
                                Kabupaten</option>
                            <option value="Kec" value="Pusat" <?= set_value('dpr_tingkat')=='Kec' ? "selected" : "";?>>
                                Kecamatan</option>
                        </select>
                    </div>
                    <br />
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control float-right data-datepicker" id="expired" name="expired"
                            placeholder="Tanggal Akhir SK..." value="<?= set_value('expired');?>" />
                    </div>
                    <br />
                    <label for="alamat" class="element">Alamat Kantor</label>
                    <div class="element">
                        <textarea name="alamat" id="alamat" class="form-control"
                            placeholder="Alamat Kantor..."><?= set_value('alamat');?></textarea>
                    </div>
                    <br />

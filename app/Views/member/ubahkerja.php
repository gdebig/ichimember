...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/pengkerja/ubahkerjaproses" method="post"
                enctype="multipart/form-data">
                <input type="hidden" id="user_id" name="user_id" value="<?= $user_id;?>" />
                <input type="hidden" id="kerja_id" name="kerja_id" value="<?= $kerja_id;?>" />
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="namainstansi" name="namainstansi" class="form-control" type="text"
                            placeholder="Nama Instansi / Tempat Kerja..." value="<?= $namainstansi;?>" />
                    </div>
                    <br />

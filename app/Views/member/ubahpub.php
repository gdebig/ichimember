...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/publikasi/ubahpubproses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <select name="tipepublikasi" id="tipepublikasi" class="form-control">
                            <option value="Artikel" <?= $tipepublikasi=='Artikel' ? "selected" : "";?>>
                                Artikel</option>
                            <option value="Makalah" <?= $tipepublikasi=='Makalah' ? "selected" : "";?>>
                                Makalah</option>
                            <option value="Buku" <?= $tipepublikasi=='Buku' ? "selected" : "";?>>Buku
                            </option>
                        </select>
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="mediapublikasi" name="mediapublikasi" class="form-control" type="text"
                            placeholder="Nama Journal/Proceeding/Media Publikasi..." value="<?= $mediapublikasi;?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="linkpub" name="linkpub" class="form-control" type="text"
                            placeholder="Link Publikasi..." value="<?= $linkpub;?>" />
                    </div>
                    <br />
                    <div class="form-group">
